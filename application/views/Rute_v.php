...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="<?php echo base_url('gudang/Admin/');?>bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url('gudang/Admin/');?>plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url('gudang/Admin/');?>plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url('gudang/Admin/');?>plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url('gudang/Admin/');?>plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url('gudang/Admin/');?>plugins/daterangepicker/daterangepicker.css">
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Nadia Ramadhani</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box-body">
        <a style="cursor: pointer;" onclick="href='<?php echo base_url('admin/form_rute'); ?>'" class="btn btn-primary btn-sm">
